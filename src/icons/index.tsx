...
function Home({variant, ...props}: IconProps) {
    return (
        <svg {...props} viewBox="0 0 24 24" width="24" fill="currentColor">
            {variant ? (
...
function Browse({variant, ...props}: IconProps) {
    return (
        <svg {...props} viewBox="0 0 24 24" width="24" fill="currentColor">
            {variant ? (
...
function Search({width, ...props}: IconProps) {
    return (
        <svg {...props} viewBox="0 0 16 16" width={width ?? 16} fill="currentColor">
...
function LibraryOpen({variant, ...props}: IconProps) {
    return (
        <svg {...props} viewBox="0 0 22 22" width="22" fill="currentColor">
            {variant ? (
...
function Saved({variant, ...props}: IconProps) {
    return (
        <svg {...props} viewBox="0 0 16 16" width="16" fill="currentColor">
            {!variant ? (
                <>
